-- ============================================================================
-- MPSI CHALLENGE — PATCH 0015 : la case 15 accueille 4 membres au lieu de 3
-- À exécuter UNE FOIS dans Supabase → SQL Editor.
--
-- claim_team_slot accepte désormais un 4e coéquipier (p_member4, facultatif).
--   - Case 15      → 3 coéquipiers obligatoires (4 membres au total, toi inclus)
--   - Cases 1 à 14 → 2 coéquipiers (comportement inchangé)
-- ============================================================================
...
begin
  ...
  -- Constitution de la liste des membres selon la case
  if p_slot = 15 then
  ...
  -- Vérifications : membres distincts, tous en MPSI, aucun déjà dans une équipe
